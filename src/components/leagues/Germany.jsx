...
const Germany = () => {
  ...
  const germanyPredictions = predictions
    .filter((predict) => predict.country == "Germany")
    .sort((a, b) => new Date(b.date) - new Date(a.date));
  
  const currentPredictions = germanyPredictions.slice(
  ...
  return (
    <div>
      ...
      <Pagination
        ...
        current={currentPage}
        total={germanyPredictions.length}
        pageSize={pageSize}
